...
${OBJECTDIR}/_ext/1062337698/comgt.o: ../open3g/./source/comgt.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/comgt.o ../open3g/./source/comgt.c

${OBJECTDIR}/_ext/1062337698/coninfo.o: ../open3g/./source/coninfo.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1062337698
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/coninfo.o ../open3g/./source/coninfo.c

${OBJECTDIR}/_ext/1062337698/corebase.o: ../open3g/./source/corebase.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1062337698
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/corebase.o ../open3g/./source/corebase.c

${OBJECTDIR}/_ext/1062337698/main.o: ../open3g/./source/main.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1062337698
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/main.o ../open3g/./source/main.c

${OBJECTDIR}/_ext/1062337698/mainlog.o: ../open3g/./source/mainlog.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1062337698
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/mainlog.o ../open3g/./source/mainlog.c

${OBJECTDIR}/_ext/1062337698/monitor.o: ../open3g/./source/monitor.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1062337698
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1062337698/monitor.o ../open3g/./source/monitor.c
